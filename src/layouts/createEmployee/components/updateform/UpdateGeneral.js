...
import { getUserById } from 'utility/apiService';
import { AddressView } from 'utility/apiService';
import { ViewUserFamily } from 'utility/apiService';
export default function GeneralDetails(){
     ...
     const getUserData = async () => {
          try {
               await getUserById(userId.userId.id).then((res) => {
                    //console.log(res);
                    setFirstName(res.data.firstName);
                    setLastName(res.data.lastName);
                    setDob(res.data.dob);
                    setEmail(res.data.email);
                    setSelectedgender({value:res.data.gender,label:res.data.gender})
                    setSelectedstatus({value:res.data.marriageStatus,label:res.data.marriageStatus})
               ...
               await AddressView(userId.userId.id).then((res) => {
                    // console.log(res);
               ...
               await ViewUserFamily(userId.userId.id).then((res) => {
                    console.log(res.data);
                    setFamilyMembers(res.data);
                    // setFamilyMembers(familyMembers.concat(res.data));
               }).catch((err) => {
                    console.log(err);
               });
          } catch (error) {
                    ...
                    <MDBox
                         ...
                         <MDBox
                              ...
                              <MDBox>
                                   <CustomSelect
                                        option={gender}
                                        placeholder={selectedgender?.label?selectedgender.label:'Select'}
                              ...
                              <MDBox>
                                   <CustomSelect
                                        ...
                                        placeholder={selectedstatus?.label?selectedstatus.label:'Select'}
