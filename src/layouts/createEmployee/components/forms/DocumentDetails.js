...
export default function DocumentDetails() {
     ...
     const handleSubmit = (e) => {
          ...
          valid=true
          if(!accountNo){
               setAnoerrorMessage("Account No Required")
               valid=false
          }
             else{
               setAnoerrorMessage("")
          ...
          if(!ifsc) {
               setIfscerrorMessage("Ifsc No  Required")
               valid=false
               }
            else{
               setIfscerrorMessage("")
               ...
               if(!branch){
                ...
                valid=false
                 ...
                 if (!adhaarNo) {
                    setAdhaarerrorMessage( 'Aadhaar No is required' );
                    valid=false
               } else if (adhaarNo.length < 12 || adhaarNo.length > 12) {
                    setAdhaarerrorMessage('Aadhaar No must be 12 characters long' );
                    valid=false
               } else {
                    setAdhaarerrorMessage('');
               }
               ...
               if(!panNo){
                   setPanerrorMessage("Pan No Required")
                   valid=false
               
               }
                   else  if(panNo){
                    if (!pan.test(panNo)) {
                         setPanerrorMessage("Please enter the correct format  ")
                         valid=false
                    } else {
                         setPanerrorMessage("")
                ...
                if(passportNo){
                         ...
                         setPassporterrorMessage("Please enter the correct format  ")
                         valid=false
               ...
               if(!uanNo){
                    setUanerrorMessage("Uan No Required")
                    valid =false
                    }
                    else   if(uanNo){
                         if (!uan.test(uanNo)) {
                         setUanerrorMessage("Please enter the correct format  ")
                         valid=false
                         } else {
                              setUanerrorMessage("")
               ...
               if(!pfNo){
                    setPferrorMessage("Pf No Required")
                    valid =false
                    } 
                    else  if(pfNo){
                         if (!pf.test(pfNo)) {
                         setPferrorMessage("Please enter the correct format  ")
                         valid=false
               ...
               if(!esiNo){
                    setEsierrorMessage("Esi No Required")
                    valid =false
                    } 
                    else{
                         setEsierrorMessage("")
               ...
               if(!vaccination1Date){
                    setV1errorMessage("vaccinate1 Date Required")
                    valid =false
                    } 
                    else{
                         setV1errorMessage("")
